...
export const meta = {
  ...
  banner: {
    src: '/assets/blog/custom-layout-in-nextjs/banner.jpg',
    height: 400,
    width: 800
  },
  bannerAlt: 'Photo by Milad Fakurian on Unsplash',
  bannerLink: '',
  description: 'Learn how to create Single Shared Layouts and Per-Page Layouts in Next.js.',
...
's modular nature allows us to create reusable components, and layouts are no exception. In Next.js, there's a variety of ways to implement custom layouts. In this blog, we'll explore two of the most common approaches:
